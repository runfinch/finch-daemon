...
func (nc *NerdctlWrapper) RunBuild(ctx context.Context, client *containerd.Client, options types.BuilderBuildOptions, buildID string) error {
...
// TODO: Make this a public function in nerdctl.
