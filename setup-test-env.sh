...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    --help)
      ...
      echo "Options:"
      echo "  --runc-version VERSION       Set runc version (default: 1.3.0)"
      echo "  --containerd-version VERSION Set containerd version (default: 1.7.27)"
      echo "  --nerdctl-version VERSION    Set nerdctl version (default: 2.1.3)"
      echo "  --buildkit-version VERSION   Set buildkit version (default: 0.23.2)"
      echo "  --cni-version VERSION        Set CNI plugins version (default: 1.6.2)"
...
BUILDKIT_VERSION=${BUILDKIT_VERSION:-0.23.2}
