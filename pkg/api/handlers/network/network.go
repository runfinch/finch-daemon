...
//go:generate mockgen --destination=../../../mocks/mocks_network/networksvc.go -package=mocks_network github.com/runfinch/finch-daemon/pkg/api/handlers/network Service
