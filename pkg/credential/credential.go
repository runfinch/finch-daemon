...
// NewService creates a new credential service with a shared cache
...
// GenerateBuildID creates a cryptographically secure random build ID using UUID
...
// findMatch is a helper function that tries to match a serverURL against a list of targets
// using the provided matching function
