...
// GetDaemonBinary mocks base method.
func (m *MockNerdctlContainerSvc) GetDaemonBinary() (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDaemonBinary")
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDaemonBinary indicates an expected call of GetDaemonBinary.
func (mr *MockNerdctlContainerSvcMockRecorder) GetDaemonBinary() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDaemonBinary", reflect.TypeOf((*MockNerdctlContainerSvc)(nil).GetDaemonBinary))
}
