...
//
//	mockgen --destination=../../mocks/mocks_backend/nerdctlsystemsvc.go -package=mocks_backend github.com/runfinch/finch-daemon/internal/backend NerdctlSystemSvc
//
...
func (m *MockNerdctlSystemSvc) GetServerVersion(ctx context.Context) (*dockercompat.ServerVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServerVersion", ctx)
...
func (mr *MockNerdctlSystemSvcMockRecorder) GetServerVersion(ctx any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetServerVersion", reflect.TypeOf((*MockNerdctlSystemSvc)(nil).GetServerVersion), ctx)
}
